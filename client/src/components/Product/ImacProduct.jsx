...
function ImacProduct() {
    ...
    async function fetchProduct() {
      try {
        const { data } = await axios.get(
          "https://642c149b208dfe254727719c.mockapi.io/imac/" + id
        );
        setProduct(data);
      } catch (error) {
  ...
  const onClickAdd = () => {
    const item = {
      ...
      storage: product.storage[activeStorage],
    };
          ...
          <div className={s.wrap}>
            ...
            <div className={s.wrapper}>
              ...
              <div className={s.containerChoice}>
                ...
                <div className={s.wrapChoice}>
                  <p className={s.titleChoice}>Storage device</p>
                  <div className={s.wrapperChoice}>
                    {product.storage.map((storage, index) => (
                      <button
                        ...
                        onClick={() => setActiveStorage(index)}
                      >
                        {storage}
                      </button>
                    ))}
